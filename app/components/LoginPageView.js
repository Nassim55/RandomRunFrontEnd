...
const LoginPageView = () => {
  ...
  const transitionForgotPassword = useTransition(isForgotPassword, {
    duration: 400,
  });
  ...
  const loginButtonHttpResponse = useSelector(
    (state) => state.loginButtonHttpResponse,
  );

  const httpAuthType = useSelector((state) => state.httpAuthType);

  return (
    <ImageBackground style={styles.pageContent} source={landingPageBackground}>
      ...
      <View style={styles.cardsContainer}>
        <Animated.View
          style={[
            styles.card,
            {
              transform: [{translateX: translateXLogin}, {translateY}],
            },
          ]}>
          ...
          <View style={styles.forms}>
            <View style={styles.formAndMessageContainer}>
              <Text style={styles.httpResponseText}>
                {loginButtonHttpResponse.username[0]}
              </Text>
              <TextInput
            ...
            <View style={styles.formAndMessageContainer}>
              <Text style={styles.httpResponseText}>
                {loginButtonHttpResponse.password[0]}
              </Text>
              <TextInput
                style={styles.inputForm}
                label="Password"
            ...
            <View style={styles.formAndMessageContainer}>
              <Text style={styles.httpResponseText}>
                {loginButtonHttpResponse.non_field_errors[0]}
              </Text>
              <Button
        ...
        <Animated.View
          ...
          <View style={styles.cardTopText}>
            ...
            <Text style={styles.welcomeTextBottom}>
              Sign up for a Random Run account
            </Text>
          </View>
          <View style={styles.forms}>
            <Button
        ...
        <Animated.View
          ...
          <View style={styles.cardTopText}>
            ...
            <Text style={styles.welcomeTextBottom}>
              Enter your email to receive a reset form
            </Text>
          </View>
          <View style={styles.forms}>
            <View style={styles.formAndMessageContainer}>
