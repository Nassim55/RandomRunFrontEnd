        ...
        <View style={styles.routeCetailsCardAndSaveContainer}>
          <View style={styles.routeDetailsCard}>
            <View style={[styles.cardSegments, styles.cardSegmentLeft]}>
              <View
                style={[
                  styles.cardSegmentTextContainer,
                  styles.cardSegmentTextContainerTop,
                ]}>
              ...
              <View
                style={[
                  styles.cardSegmentTextContainer,
                  styles.cardSegmentTextContainerBottom,
                ]}>
                <Text
                  style={
                    styles.cardSegmentTextBottom
                  }>{`${props.displayRouteDistance.toFixed(0)} meters`}</Text>
              </View>
            </View>
