...
const LoginForms = (props) => {
  ...
  if (
    httpMessage.password[0] === '' &&
    httpMessage.non_field_errors[0] === '' &&
    httpMessage.username[0] === 'This field may not be blank.'
  ) {
    httpResponseDisplayMessage = 'Enter your email';
  } else if (
    httpMessage.username[0] === '' &&
    httpMessage.non_field_errors[0] === '' &&
    httpMessage.password[0] === 'This field may not be blank.'
  ) {
    ...
    <View style={styles.container}>
      <View style={styles.titleGrouping}>
        ...
        <Text style={styles.description}>
          Enter your credentials, alternatively log in using Google or Facebook.
        </Text>
      </View>
      <View style={styles.formGrouping}>
        <Text style={[styles.description, styles.httpResponseText]}>
          {httpResponseDisplayMessage}
        </Text>
        <TextInput
          icon="mail"
